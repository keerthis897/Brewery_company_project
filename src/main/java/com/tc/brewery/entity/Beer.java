...
public class Beer {
    ...
    public Beer(int id, String name, String description, String image_url, int abv, int ibu, String category, String brewers_tips, String ingredient_name, String food_pairing, String tagline, BigDecimal manual_ratings) {
        this.id = id;
        this.name = name;
